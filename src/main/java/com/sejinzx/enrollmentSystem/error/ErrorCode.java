...
public enum ErrorCode {
    ...
    CLASS_NOT_OPEN(HttpStatus.FORBIDDEN, "신청 가능한 상태가 아닙니다"),
    CLASS_MODIFICATION_NOT_ALLOWED(HttpStatus.FORBIDDEN, "해당 상태에서는 수정할 수 없습니다"),
    CLASS_DELETE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "해당 상태에서는 삭제할 수 없습니다"),
    ...
    CLASS_CURRENT_APPS_INVALID(HttpStatus.CONFLICT, "현재 신청 인원이 0명이라 감소할 수 없습니다."),
